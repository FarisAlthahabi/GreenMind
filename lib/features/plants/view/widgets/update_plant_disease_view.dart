...
// class UpdatePlantDiseaseView extends StatelessWidget {
//   const UpdatePlantDiseaseView({
//     super.key,
//     required this.plant,
//     this.onSuccess,
...
//       ],
//       child: UpdatePlantDiseaseWidget(plant: plant, onSuccess: onSuccess),
//     );
//   }
// }

// class UpdatePlantDiseaseWidget extends StatefulWidget {
//   const UpdatePlantDiseaseWidget({
//     super.key,
//     required this.plant,
//     this.onSuccess,
//   });
...
//   @override
//   State<UpdatePlantDiseaseWidget> createState() =>
//       _UpdatePlantDiseaseWidgetState();
// }

// class _UpdatePlantDiseaseWidgetState extends State<UpdatePlantDiseaseWidget> {
...
//     plantsCubit.setDiseaseId(widget.plant.disease);
//   }
...
//         children: [
//           Expanded(child: const Text("disease_status").tr()),
//           _buildCloseIcon(),
//         ],
//       ),
...
//           mainAxisSize: .min,
//           children: [
//             BlocBuilder<DiseasesCubit, GeneralDiseasesState>(
...
//                     buildWhen: (_, current) =>
//                         current is UpdatePlantDiseaseState,
//                     listener: (context, state) {
//                       if (state is UpdatePlantDiseaseSuccess) {
//                         widget.onSuccess?.call();
//                         onCancelTap(context);
//                         MainSnackBar.showSuccessMessage(context, state.message);
//                       } else if (state is UpdatePlantDiseaseFail) {
//                         MainSnackBar.showErrorMessage(context, state.error);
//                       }
//                     },
//                     builder: (context, state) {
//                       var onTap = () =>
//                           plantsCubit.updateDiseaseStatus(widget.plant.id);
//                       Widget? child;
//                       if (state is UpdatePlantDiseaseLoading) {
//                         onTap = () async {};
